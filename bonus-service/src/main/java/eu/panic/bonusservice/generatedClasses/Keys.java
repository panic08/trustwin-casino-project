 ...
 */
package eu.panic.bonusservice.generatedClasses;


import eu.panic.bonusservice.generatedClasses.tables.FlywaySchemaHistory;
import eu.panic.bonusservice.generatedClasses.tables.GamesTable;
import eu.panic.bonusservice.generatedClasses.tables.MessagesTable;
import eu.panic.bonusservice.generatedClasses.tables.ReplenishmentsTable;
import eu.panic.bonusservice.generatedClasses.tables.SignInHistoryTable;
...
import eu.panic.bonusservice.generatedClasses.tables.records.FlywaySchemaHistoryRecord;
import eu.panic.bonusservice.generatedClasses.tables.records.GamesTableRecord;
import eu.panic.bonusservice.generatedClasses.tables.records.MessagesTableRecord;
import eu.panic.bonusservice.generatedClasses.tables.records.ReplenishmentsTableRecord;
import eu.panic.bonusservice.generatedClasses.tables.records.SignInHistoryTableRecord;
import eu.panic.bonusservice.generatedClasses.tables.records.UsersTableRecord;
import eu.panic.bonusservice.generatedClasses.tables.records.WithdrawalsTableRecord;
