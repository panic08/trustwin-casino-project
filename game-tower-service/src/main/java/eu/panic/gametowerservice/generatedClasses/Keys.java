 ...
 */
package eu.panic.gametowerservice.generatedClasses;
...
import eu.panic.gametowerservice.generatedClasses.tables.WithdrawalsTable;
import eu.panic.gametowerservice.generatedClasses.tables.records.FlywaySchemaHistoryRecord;
import eu.panic.gametowerservice.generatedClasses.tables.records.GamesTableRecord;
import eu.panic.gametowerservice.generatedClasses.tables.records.MessagesTableRecord;
import eu.panic.gametowerservice.generatedClasses.tables.records.NotificationsTableRecord;
import eu.panic.gametowerservice.generatedClasses.tables.records.ReplenishmentsTableRecord;
import eu.panic.gametowerservice.generatedClasses.tables.records.SignInHistoryTableRecord;
import eu.panic.gametowerservice.generatedClasses.tables.records.UsersTableRecord;
import eu.panic.gametowerservice.generatedClasses.tables.records.WithdrawalsTableRecord;
...
public class Keys {
    ...
    public static final UniqueKey<NotificationsTableRecord> NOTIFICATIONS_TABLE_PKEY = Internal.createUniqueKey(NotificationsTable.NOTIFICATIONS_TABLE, DSL.name("notifications_table_pkey"), new TableField[] { NotificationsTable.NOTIFICATIONS_TABLE.ID }, true);
