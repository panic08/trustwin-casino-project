package eu.panic.notificationservice.template.handler;
...
public class InvalidCredentialsAdvancedHandler {
    ...
    public String handleInvalidCredentialsException(InvalidCredentialsException invalidCredentialsException){
         /*
