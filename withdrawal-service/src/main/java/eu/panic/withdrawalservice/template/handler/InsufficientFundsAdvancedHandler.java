package eu.panic.withdrawalservice.template.handler;
...
public class InsufficientFundsAdvancedHandler {
    ...
    private String handleInsufficientFundsException(InsufficientFundsException insufficientFundsException){
        /*
